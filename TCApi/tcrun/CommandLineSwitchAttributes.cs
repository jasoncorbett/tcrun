...
/// 
/// Obtained from: http://www.codeproject.com/KB/recipes/commandlineparser.aspx
...
namespace RJH.CommandLineHelper
{
	...
	public class CommandLineSwitch : System.Attribute
	{
	...
	/// </summary>
	[AttributeUsage( AttributeTargets.Property )]
	public class CommandLineAlias : System.Attribute
	{
		#region Private Variables
		...
		#region Constructors
		public CommandLineAlias( string alias ) 
		{
			m_Alias = alias;
		}
		#endregion
